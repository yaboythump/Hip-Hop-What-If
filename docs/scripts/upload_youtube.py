...
def main() -> None:
    ...
    # Real YouTube upload logic goes here in the next phase.
    # This file is intentionally staged first so we can validate naming,
    # metadata, privacy, and file structure before touching the live channel.
